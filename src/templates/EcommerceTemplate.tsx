...
export const EcommerceTemplate = ({
  ...
  const footer = (
    <div className={`bg-gradient-to-br from-primary/95 to-secondary/95 text-white py-16 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Social Links */}
          <div>
            <h3 className="font-bold mb-4 text-white text-lg">Sígueme</h3>
            <SocialLinks />
          </div>
        </div>

        <div className="mt-12 pt-8 border-t border-white/20 text-center text-white/80">
          <p className="font-medium">&copy; 2024 Neurociencia y Empoderamiento. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  )
