...
export const ProductCardUI = ({ product }: ProductCardUIProps) => {
  return (
    <HeadlessProductCard product={product}>
      {(logic) => (
        <Card className="group bg-card border-border hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          <CardContent className="p-5">
            <Link to={`/products/${logic.product.slug}`} className="block">
              <div className="aspect-square bg-muted rounded-lg mb-4 overflow-hidden relative">
                ...
                <div className="absolute top-3 left-3 flex flex-col gap-2">
                  ...
                  {!logic.inStock && (
                    <span className="bg-muted text-muted-foreground text-xs px-3 py-1 rounded-full font-bold shadow-lg">
                      Agotado
                    </span>
                  )}
                </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t">
              ...
              <Button
                ...
                className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold px-6 disabled:opacity-50"
              >
